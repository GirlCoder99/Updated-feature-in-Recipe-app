...
async function showMealInfo(mealData) {
    //clean it up
    ...
    term = mealData.strMeal;
    itemname = term.split(" ");
    console.log(itemname[0]);
    data = await getMealsBySearch(itemname[0]);
    console.log(data[0])
    ...
    <div>
        <h2 style = "text-align:center">You may find Items of this category</h2>
    </div>
    `;
    mealsEl.appendChild(similar);
